// Package util
// https://github.com/jkbicbic/gopager/blob/master/gopager/gopager.go
package util
...
// NewPagination builds a new pagination
func NewPagination(count, pageLimit, currentPage, pagerLength int) *Pagination {
	return &Pagination{
